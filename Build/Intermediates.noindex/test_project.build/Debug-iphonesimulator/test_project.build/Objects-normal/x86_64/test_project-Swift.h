...
#ifndef TEST_PROJECT_SWIFT_H
#define TEST_PROJECT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="test_project",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12test_project11AppDelegate")
...
SWIFT_CLASS("_TtC12test_project8NewsCell")
...
SWIFT_CLASS("_TtC12test_project18NewsViewController")
...
SWIFT_CLASS("_TtC12test_project13SceneDelegate")
...
SWIFT_CLASS("_TtC12test_project14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(test_project)) <UITableViewDataSource, UITableViewDelegate>
